...
import GradientView from "@/generated/components/reference/components/GradientView";

export default function Page() {
  const router = useRouter();
  const { data } = useComponentReference(router, "GradientView");
  return <GradientView data={data} />;
}
