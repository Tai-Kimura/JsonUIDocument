...
const NAV_CATALOG: ReadonlyArray<{
  ...
  },
  {
    ...
    entries: [
      ...
      { id: "contract-gaps",           titleKey: "guides_contract_gaps_title",           titleEn: "Contract gaps",               url: "/guides/contract-gaps" },
      ...
      { id: "web-framework-adapters",  titleKey: "guides_web_framework_adapters_title",  titleEn: "Web framework adapters",      url: "/guides/web-framework-adapters" },
