  ...
  describe '#convert' do
    ...
    context 'with lazy: false' do
      it 'drops overflow-y-auto for single column' do
        converter = create_converter({ 'class' => 'Collection', 'cellClasses' => ['ItemCell'], 'lazy' => false })
        result = converter.convert
        expect(result).to include('flex flex-col')
      ...
      it 'drops overflow-x-auto for horizontal' do
        converter = create_converter({ 'class' => 'Collection', 'layout' => 'horizontal', 'cellClasses' => ['ItemCell'], 'lazy' => false })
        result = converter.convert
        expect(result).to include('flex flex-row')
      ...
      it 'keeps overflow classes when lazy defaults to true' do
        converter = create_converter({ 'class' => 'Collection', 'cellClasses' => ['ItemCell'] })
        result = converter.convert
