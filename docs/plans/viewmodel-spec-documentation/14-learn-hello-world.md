---
title: "Plan 14 — Hello World ViewModel documentation"
status: open
depends_on: [00-overview]
spec: docs/screens/json/learn/hello-world.spec.json
shape: rich
owner: jsonui-define
---
...
- uiVariables: `currentLanguage:String, breadcrumbItems:[BreadcrumbItem], prerequisites:[Prereq…`
- eventHandlers: `onAppear, onSelectTab, onNavigate, onToggleLanguage`
- customTypes: `BreadcrumbItem, Prerequisite, QuickstartStep, PlatformTab, NextStepLink`
...
String-key prefix: **`learn_hello_world_`**.

### Navigation destinations

`/guides`, `/learn`, `/learn/data-binding-basics`, `/learn/first-screen`, `/tools/agents/overview`
