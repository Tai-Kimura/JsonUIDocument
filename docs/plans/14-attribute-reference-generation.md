        ...
        { "include": "common/sidebar_reference", "platforms": ["web"] },
        {
          ...
          "child": [
            ...
            { "type": "Label", "text": "@{componentDescription}", "style": "prose_paragraph" },
            {
              ...
              "child": [
                { "type": "PlatformBadge", "platform": "uikit",   "supported": "@{platforms.uikit}" },
                { "type": "PlatformBadge", "platform": "swiftui", "supported": "@{platforms.swiftui}" },
                { "type": "PlatformBadge", "platform": "compose", "supported": "@{platforms.compose}" },
                { "type": "PlatformBadge", "platform": "xml",     "supported": "@{platforms.xml}" },
                { "type": "PlatformBadge", "platform": "web",     "supported": "@{platforms.web}" }
              ]
            },
...
### 9.1 プラットフォーム対応マトリクス
MCP spec の `platforms` から機械的に生成。`PlatformBadge` コンポーネント。
