...
| token | light | dark | 用途 |
|---|---|---|---|
| `danger` | `#E11D48` | `#F43F5E` | error / destructive |
| `danger_ink` | `#FFFFFF` | `#FFFFFF` | danger bg 上の text |
| `emphasis` | `#F43F5E` | `#FB7185` | "NEW" badge / callout 強調 |
...
`docs/screens/layouts/Resources/colors.proposed.json` に保存。upstream Phase 1 landing 後に `colors.json` にリネーム。
...
| `#EFF6FF` | 2 | `accent_tint` もしくは新規 `accent_tint_soft` | 要文脈確認 |
| `#4F46E5` | 2 | `accent_secondary` の代替？ | 要確認（1 箇所差別化する必要があるか） |
