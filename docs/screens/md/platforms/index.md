# PlatformsIndex - Platforms

## Overview

Catalog page for the Platforms section: one card per platform implementation (SwiftJsonUI, KotlinJsonUI, ReactJsonUI) with its scope and status. Rendered both at the standalone URL and inline in the home TabView; the catalog is seeded statically in the owning ViewModel, so a content repository can replace the seed later without touching this spec.
...
|---|---|---|---|---|---|
| View | `platforms_index_root` | - | - | - | - |
| &nbsp;&nbsp;↳ Scroll | `platforms_index_scroll` | - | - | - | - |
| &nbsp;&nbsp;&nbsp;&nbsp;↳ View | `platforms_index_hero` | - | - | - | - |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;↳ Label | `-` | - | - | - | - |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;↳ Label | `-` | - | - | - | - |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;↳ Label | `-` | - | - | - | - |
| &nbsp;&nbsp;&nbsp;&nbsp;↳ View | `platforms_index_catalog` | - | - | - | - |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;↳ Label | `-` | - | - | - | - |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;↳ Label | `-` | - | - | - | - |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;↳ Collection | `platforms_index_articles_collection` | - | - | - | - |

### Layout Structure

```
platforms_index_root
└── platforms_index_scroll
```
