...
export const QuickStart = ({ data }) => {
  ...
  <div id="quick_start_page" className="w-full flex flex-col">
    ...
    <div id="quick_start_hero" className="w-full py-12 px-6 bg-[#F6F7F9] flex flex-col items-center justify-center">
      <span className="text-[#23272F] text-5xl font-bold text-center">{StringManager.currentLanguage.quickStartTitle}</span>
    ...
    <div id="quick_start_content" className="w-full py-12 px-6 bg-[#FFFFFF] flex flex-col">
      ...
      <div id="swift_content" className="flex flex-col">
        <span className="text-[#FA7343] text-2xl font-bold">{StringManager.currentLanguage.qsSwiftStep1Title}</span>
        <div className="h-[8px]" />
        ...
        <div className="h-[24px]" />
        <span className="text-[#FA7343] text-2xl font-bold">{StringManager.currentLanguage.qsSwiftStep2Title}</span>
        <div className="h-[8px]" />
        ...
        <div className="h-[24px]" />
        <span className="text-[#FA7343] text-2xl font-bold">{StringManager.currentLanguage.qsSwiftStep3Title}</span>
        <div className="h-[8px]" />
      ...
      <div id="kotlin_content" className="flex flex-col">
        <span className="text-[#7F52FF] text-2xl font-bold">{StringManager.currentLanguage.qsKotlinStep1Title}</span>
        <div className="h-[8px]" />
        ...
        <div className="h-[24px]" />
        <span className="text-[#7F52FF] text-2xl font-bold">{StringManager.currentLanguage.qsKotlinStep2Title}</span>
        <div className="h-[8px]" />
        ...
        <div className="h-[24px]" />
        <span className="text-[#7F52FF] text-2xl font-bold">{StringManager.currentLanguage.qsKotlinStep3Title}</span>
        <div className="h-[8px]" />
      ...
      <div id="react_content" className="flex flex-col">
        <span className="text-[#61DAFB] text-2xl font-bold">{StringManager.currentLanguage.qsReactStep1Title}</span>
        <div className="h-[8px]" />
        ...
        <div className="h-[24px]" />
        <span className="text-[#61DAFB] text-2xl font-bold">{StringManager.currentLanguage.qsReactStep2Title}</span>
        <div className="h-[8px]" />
        ...
        <div className="h-[24px]" />
        <span className="text-[#61DAFB] text-2xl font-bold">{StringManager.currentLanguage.qsReactStep3Title}</span>
        <div className="h-[8px]" />
      ...
      <div className="flex flex-row items-stretch items-center justify-center">
        <button className="py-3 px-6 bg-transparent rounded-lg text-[#087EA4] text-base font-semibold border border-[#087EA4] cursor-pointer transition-colors hover:opacity-80 disabled:opacity-50 disabled:cursor-not-allowed" style={{ borderRadius: '8px' }} onClick={data.onClickInstallation}>{StringManager.currentLanguage.quickStartPrev}</button>
        <div className="w-[16px]" />
        <button className="py-3 px-6 bg-[#087EA4] rounded-lg text-[#FFFFFF] text-base font-semibold cursor-pointer transition-colors hover:opacity-80 disabled:opacity-50 disabled:cursor-not-allowed" style={{ borderRadius: '8px' }} onClick={data.onClickComponents}>{StringManager.currentLanguage.quickStartNext}</button>
      </div>
    </div>
  </div>
  );
