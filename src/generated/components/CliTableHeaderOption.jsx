...
export const CliTableHeaderOption = () => {
  return (
  <div id="cli_table_header_option" className="w-full flex flex-col">
    <div className="w-full py-0 px-4 bg-[#F9FAFB] flex flex-row items-stretch">
      <span className="p-3 text-[#374151] text-[13px] font-bold flex-[2] font-bold">{StringManager.currentLanguage.cliTableOption}</span>
...
export default CliTableHeaderOption;
