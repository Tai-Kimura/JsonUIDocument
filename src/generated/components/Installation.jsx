...
export const Installation = () => {
  ...
  <div id="installation_page" className="w-full flex flex-col">
    ...
    <div id="installation_content" className="w-full py-12 px-6 bg-[#FFFFFF] flex flex-col">
      ...
      <div id="swift_content" className="flex flex-col">
        ...
        <div className="flex flex-col py-4 px-4 bg-[#1E1E1E] rounded-lg">
          <span className="text-[#D4D4D4] text-sm">dependencies: [
    .package(url: "https://github.com/Tai-Kimura/SwiftJsonUI.git", from: "7.2.0")
        ...
        <div className="h-[8px]" />
        <div className="flex flex-col py-4 px-4 bg-[#1E1E1E] rounded-lg">
          <span className="text-[#D4D4D4] text-sm"># One-line installer
...
sjui_tools/bin/sjui setup</span>
        </div>
      </div>
    ...
    // Dynamic module for debug builds
...
# Initialize project
kjui_tools/bin/kjui init --mode compose</span>
        </div>
      </div>
      <div id="react_content" className="flex flex-col">
        ...
        <div className="h-[8px]" />
        <div className="flex flex-col py-4 px-4 bg-[#1E1E1E] rounded-lg">
          <span className="text-[#D4D4D4] text-sm"># Install CLI tools
curl -fsSL https://raw.githubusercontent.com/anthropics/ReactJsonUI/main/installer/bootstrap.sh | bash

# Initialize project
rjui_tools/bin/rjui init
rjui_tools/bin/rjui setup</span>
        </div>
      </div>
