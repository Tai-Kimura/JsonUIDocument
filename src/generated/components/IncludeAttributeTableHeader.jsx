...
export const IncludeAttributeTableHeader = ({ data }) => {
  return (
  <div id="include_attribute_table_header" className="w-full flex flex-col">
...
export default IncludeAttributeTableHeader;
