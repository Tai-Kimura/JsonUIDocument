...
export const RefDataBinding = ({ data }) => {
  return (
  <div id="ref_data_binding_page" className="w-full h-auto flex flex-row items-stretch">
    ...
    <div id="ref_data_binding_scroll" className="w-full h-auto overflow-y-auto flex flex-col">
      <div id="ref_data_binding_content" className="w-full py-12 px-6 bg-[#FFFFFF] flex flex-col">
        <span className="mb-2 text-[#23272F] text-[32px] font-bold">{StringManager.currentLanguage.refDataBinding}</span>
        <span className="mb-8 text-[#4B5563] text-base">{StringManager.currentLanguage.refDataBindingOverview}</span>
        <span className="mb-3 text-[#23272F] text-2xl font-bold">{StringManager.currentLanguage.refBindingDataDeclaration}</span>
        ...
        <span className="mb-3 text-[#23272F] text-2xl font-bold">{StringManager.currentLanguage.refBindingBasic}</span>
        ...
        <span className="mb-3 text-[#23272F] text-2xl font-bold">{StringManager.currentLanguage.refBindingNested}</span>
        ...
        <span className="mb-3 text-[#23272F] text-2xl font-bold">{StringManager.currentLanguage.refBindingOptional}</span>
        ...
        <span className="mb-3 text-[#23272F] text-2xl font-bold">{StringManager.currentLanguage.refBindingTernary}</span>
        ...
        <span className="mb-3 text-[#23272F] text-2xl font-bold">{StringManager.currentLanguage.refBindingVisibility}</span>
        ...
        <span className="mb-3 text-[#23272F] text-2xl font-bold">{StringManager.currentLanguage.refBindingTwoway}</span>
        ...
        <span className="mb-3 text-[#23272F] text-2xl font-bold">{StringManager.currentLanguage.refBindingNullSafety}</span>
        ...
        <span className="mb-3 text-[#23272F] text-2xl font-bold">{StringManager.currentLanguage.refBindingCollections}</span>
        ...
        <span className="mb-3 text-[#23272F] text-2xl font-bold">{StringManager.currentLanguage.refBindingGroups}</span>
        ...
        <span className="mb-3 text-[#23272F] text-2xl font-bold">{StringManager.currentLanguage.refBindingBestPractices}</span>
