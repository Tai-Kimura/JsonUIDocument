...
export const ViewDetail = ({ viewModel }) => {
  return (
  <div id="view_detail_page" className="w-full h-auto flex flex-row items-stretch">
    ...
    <div id="view_detail_scroll" className="w-full h-auto overflow-y-auto flex flex-col">
      <div id="view_detail_content" className="w-full py-12 px-6 bg-[#FFFFFF] flex flex-col">
        <span className="mb-4 text-[#23272F] text-[32px] font-bold font-bold">{StringManager.currentLanguage.compViewTitle}</span>
        <span className="mb-6 text-[#4B5563] text-base">{StringManager.currentLanguage.compViewDesc}</span>
        ...
        <div className="mb-8 flex flex-col">
          ...
          <span className="mb-2 text-[#4B5563] text-sm">{StringManager.currentLanguage.compDetailComposeSupport}</span>
