...
export const RefCircleView = ({ data }) => {
  return (
  <div id="ref_circle_view_page" className="w-full h-auto flex flex-row items-stretch">
    ...
    <div id="ref_circle_view_scroll" className="w-full h-auto overflow-y-auto flex flex-col">
      <div id="ref_circle_view_content" className="w-full py-12 px-6 bg-[#FFFFFF] flex flex-col">
        <span className="mb-4 text-[#23272F] text-[32px] font-bold">{StringManager.currentLanguage.refCircleViewTitle}</span>
        ...
        <div className="w-full rounded-lg border border-[#E5E7EB] overflow-hidden flex flex-col">
          ...
          {data.circleViewAttributes?.map((item, index) => (
