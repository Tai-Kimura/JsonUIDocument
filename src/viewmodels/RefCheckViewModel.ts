...
export class RefCheckViewModel {
  ...
  get checkAttributes(): RefAttributeData[] {
    return [
      { name: "label", uikit: true, swiftui: true, compose: true, xml: false, react: false, type: "string", description: StringManager.getString("ref_check_attr_label_desc") },
      ...
      { name: "checked", uikit: true, swiftui: true, compose: true, xml: true, react: false, type: "boolean/string", description: StringManager.getString("ref_check_attr_checked_desc") },
      ...
      { name: "enabled", uikit: true, swiftui: true, compose: true, xml: true, react: false, type: "boolean/string", description: StringManager.getString("ref_check_attr_enabled_desc"), isLast: true }
    ];
  }
}
