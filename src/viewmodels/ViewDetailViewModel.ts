...
export class ViewDetailViewModel {
  ...
  get viewAttributes(): AttributeData[] {
    return [
      ...
      { name: "direction", uikit: true, swiftui: true, compose: true, xml: false, react: true, type: "string" },
      { name: "gravity", uikit: true, swiftui: true, compose: true, xml: true, react: true, type: "string" },
      { name: "highlightBackground", uikit: true, swiftui: true, compose: false, xml: false, react: true, type: "string" },
      { name: "highlighted", uikit: true, swiftui: true, compose: false, xml: false, react: true, type: "boolean" },
      ...
      { name: "onClick", uikit: true, swiftui: true, compose: true, xml: true, react: true, type: "string" },
      { name: "onLongPress", uikit: true, swiftui: true, compose: true, xml: false, react: true, type: "string" },
      { name: "onPan", uikit: true, swiftui: true, compose: false, xml: false, react: true, type: "string" },
      { name: "onPinch", uikit: true, swiftui: true, compose: false, xml: false, react: true, type: "string" },
