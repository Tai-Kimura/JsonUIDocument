...
export class TextFieldDetailViewModel {
  ...
  get textFieldAttributes(): AttributeData[] {
    return [
      ...
      { name: "hintColor", uikit: true, swiftui: true, compose: true, xml: true, type: "string" },
      { name: "input", uikit: true, swiftui: true, compose: true, xml: true, type: "string" },
      { name: "secure", uikit: true, swiftui: true, compose: true, xml: true, type: "boolean" },
      { name: "returnKeyType", uikit: true, swiftui: true, compose: true, xml: true, type: "string" },
