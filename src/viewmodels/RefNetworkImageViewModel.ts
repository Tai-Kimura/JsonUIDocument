...
export class RefNetworkImageViewModel {
  ...
  get networkImageAttributes(): RefAttributeData[] {
    return [
      { name: "src", uikit: true, swiftui: true, compose: false, xml: false, react: false, type: "string", description: StringManager.getString("ref_network_image_src_desc") },
      ...
      { name: "contentMode", uikit: true, swiftui: true, compose: false, xml: false, react: false, type: "string", description: StringManager.getString("ref_network_image_content_mode_desc") },
